...
1. 主控台热力图和空气站点贡献排名是两条展示路径：热力图读取 `concentrations` / `pollutantConcentrations` 的网格浓度场；贡献排名读取 `receptorContributions[空气站点][污染物]`。
...
# 预期：Test Files 20 passed, Tests 107 passed
